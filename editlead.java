...
public class editlead {
	...
	// 17. Clear the Description Field using .clear()
		WebElement descriptionUpdate=driver.findElement(By.id("updateLeadForm_description"));
		descriptionUpdate.clear();
	// 18. Fill ImportantNote Field with Any text
		WebElement importantNote=driver.findElement(By.id("updateLeadForm_importantNote"));
		importantNote.sendKeys("Scrum and PMP certified resource.");
		//19. Click on update button 
		WebElement smallSubmit=driver.findElement(By.name("submitButton"));
		smallSubmit.click();
